...
![image-1](/static/ws02-image-1.png)
...
![sessions](/static/ws02-sessions.png)
...
![image](/static/ws02-query_paste_popup.png)

If the result is normal, you can see the screen below.

![image](/static/ws02-staging_table_result.png)
...
2. Let's see the impact of executing the rank() qeury.   
   ...
   ![image](/static/ws02-taskbar_cmd.png)   
...
SQL> SELECT userid, rank() OVER (ORDER BY USERLEVEL DESC, EXPOINT DESC) AS rank FROM USER_SCORE;
```
![image](/static/ws02-1.png)   



You can see the test result.

![image](/static/ws02-gatling_result.png)   
...
![image2](/static/ws02-2.png)
![image2-1](/static/ws02-2-1.png)
![image3](/static/ws02-3.png)
...
4. You can check the test result.   
   The result show you better performance than Oracle test.   
    ...
    ![image](/static/ws02-redis_stat.png)
...
5. Open the web site from the link above and see the test result.  
   The average latency of p95 is 20ms and the impact of zrevrange function is very low.
    ...
    ![image](/static/ws02-5.png)
    ![image](/static/ws02-5-1.png)
    ![image](/static/ws02-6.png)
...
![image](/static/ws02-recap_performance.png)
...
[To the next - workshop03(Accelerate Limited Offer using REDIS)](../workshop03/index.en.md) 
